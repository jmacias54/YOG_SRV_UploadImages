var pathLigaPrincipal = '/portal/unotv/imagenes_noticias/';
...
function uploadPrincipalAMX(){	
	try {		
		...
		$.ajax({
		    url: '/uploadUnoTV/uploadPrincipal',
		    data: data,
		    cache: false,
		    contentType: false,
		    processData:false,
			...
			if(data == 'ERROR') {
				...
				document.getElementById('cargaArchivoPrincipal').style.display = 'none';
				document.getElementById('procesandoPrincipal').style.display = 'block';
				document.getElementById('procesandoPrincipal').innerHTML='Ocurrio un error al cargar el archivo. <a href="javascript:cargarOtraImagen()">Intentar de nuevo.</a>';
			} else if (data == 'MAXTAM') {
				document.getElementById('namePrincipal').value = 'N/A';
				document.getElementById('cargaArchivoPrincipal').style.display = 'none';
				document.getElementById('procesandoPrincipal').style.display = 'block';
				document.getElementById('procesandoPrincipal').innerHTML='Se intento subir un archivo de mayor tama&ntilde;o al maximo permitido. <a href="javascript:cargarOtraImagen()">Intentar de nuevo.</a>';
			}else if (data == 'TIPOAR') {
				document.getElementById('namePrincipal').value = 'N/A';
				document.getElementById('cargaArchivoPrincipal').style.display = 'none';
				document.getElementById('procesandoPrincipal').style.display = 'block';
				document.getElementById('procesandoPrincipal').innerHTML='Se intento subir un archivo de diferente extenci&oacute;n a la permitidas. <a href="javascript:cargarOtraImagen()">Intentar de nuevo.</a>';
			} else {
